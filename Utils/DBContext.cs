...
namespace Tutoree.Utils
{
    public class DBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Data Source=localhost,1433;Initial Catalog=Tutoree;User ID=sa;Password=1234567890;MultipleActiveResultSets=true;Integrated Security=false;TrustServerCertificate=true");
        }
